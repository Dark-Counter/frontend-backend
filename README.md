...
*(В отчёте можно заменить «Запрос 1» … «Запрос 5» на конкретные названия, например: «GET /posts», «GET /users/1» и т.д., в зависимости от выбранного API.)*
...
Ссылка на репозиторий сдаётся в СДО: *Задания для самостоятельной работы → Практические занятия 3–4*.
